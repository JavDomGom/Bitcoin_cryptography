...
\section{Almacenamiento en ficheros}
    Dependiendo del sistema operativo que tenga la computadora donde se esté ejecutando el cliente \textit{Bitcoin Core} los archivos que contienen todos los datos de los bloques ya minados se almacenan en diferentes directorios, véase la siguiente tabla:
    ...
    Para la realización de este documento y sus ejemplos se ha empleado un sistema operativo 100\% libre\footnote{https://www.gnu.org/distros/free-distros.es.html} GNU/Linux. Si se listan los archivos que contiene el directorio $\sim$/.bitcoin/blocks/ se encontrarán muchos archivos del siguiente tipo:
