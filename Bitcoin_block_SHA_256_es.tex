...
int main(int argc, char *argv[]) {
    ...
    printf("Timestamp epoch: %ld\n", (long) tod);
        ...
        A continuación se muestra un fragmento de código escrito en lenguaje C++ que realiza el cálculo necesario y que se puede emplear para hallar la dificultad de minado\footnote{https://en.bitcoin.it/wiki/Difficulty}. Hay que tener en cuenta el valor de la variable \textit{targetDifficulty} en cada caso, por ejemplo en el bloque \texttt{\#}286819 dicho valor es \texttt{0x19015f53}.
