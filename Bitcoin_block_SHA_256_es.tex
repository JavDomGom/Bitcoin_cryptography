...
\section{Estructura de datos de un bloque}
    ...
    Cuando se habla de un bloque de la cadena de bloques de Bitcoin en realidad se está haciendo referencia a una serie de datos ordenados en una estructura que cumple ciertos requisitos y con una lógica definida que se explicará en los siguientes puntos. Cada uno de estos datos de la estructura de datos tiene sus propios atributos, como puede ser el tipo de dato, también llamado tipo primitivo, el nombre, el tamaño que ocupa en memoria y el formato en el que este se representará finalmente. En la siguiente tabla se categorizan los principales los más significativos.
    \begin{table}[H]
    \centering
