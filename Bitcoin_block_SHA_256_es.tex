...
\section{Construcción de la cadena de entrada M}
    ...
    Finalmente se concatenan uno a continuación de otro, empezando por versión, hash del bloque anterior, merkle root, timestamp, bits y nonce:
    \begin{figure}[H]
    \centering
    \scriptsize{
        $\texttt{M = 0200000017975b97c18ed1f7e255adf297599b55330edab87803c81701000000000000008a97295a2747b4f1a0b3948df3990344c0e19fa6b2b92b3a19c8e6badc141787358b0553535f011948750833}$
    }
    \end{figure}
