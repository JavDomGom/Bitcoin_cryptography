...
\section{Almacenamiento en ficheros}
    Llegados a este punto el lector puede que se pregunte cómo se almacenan todos estos datos en una computadora. Así es como se ven los datos de un bloque almacenados en un fichero blk*.dat.
    \begin{figure}[H]
