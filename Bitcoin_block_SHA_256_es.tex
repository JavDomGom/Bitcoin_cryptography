...
\section{Los 16 registros de $W_t$}
    ...
    Después de los 64 ciclos criptográficos de $W_t$ en esta ronda 0 se obtiene el siguiente digest:
    ...
    En esta segunda ronda se han de rellenar los primeros 16 elementos de $W_t$ con los bits del mensaje $M$ original de 640 bits que no cabían en la ronda anterior, es decir dc141787+358b0553+535f0119+48750833, tal y como se muestra en la imagen.
    \begin{figure}[H]
    \centering
