...
\section{Estructura de datos de un bloque}
    ...
    Cuando se habla sobre un bloque de la cadena de bloques de Bitcoin en realidad se está haciendo referencia a una serie de datos ordenados en 5 bloques principales. Los 5 bloques son los siguientes:
